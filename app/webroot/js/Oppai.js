/** コードサンプル
    ...
    tt(function(){
        var left = {
                vertex: [247, 423], // ｵﾊﾟｰｲ頂点
                rect:   [[207, 399], [299, 475]] // ｵﾊﾟｰｲ範囲
            },
            right = {
                vertex: [397, 431], // ｵﾊﾟｰｲ頂点
                rect:   [[343, 399], [432, 483]] // ｵﾊﾟｰｲ範囲
            };

        oppai(
            "https://dl.dropbox.com/s/w3dxgmke8sti0vm/pai_03.jpg", // ｵﾊﾟｰｲ画像を指定
            "#viewer", // ｵﾊﾟｰｲを表示するElementを指定
            left, // 1つめのｵﾊﾟｰｲ情報を渡す
            right // 2つめのｵﾊﾟｰｲ情報を渡す
        );
    });
*/
...
;(function(global, document, tt, undefined) {
    ...
    Oppai.prototype = {
        ...
        init: function(img, viewer, vertex, rect) {
            ...
            if (tt.env.ios || (tt.env.android && tt.env.chrome)) {
        ...
        _deviceMotion: function(ev) {
            ...
            !this._startVertex && this.transform(currentVertex);
        },
